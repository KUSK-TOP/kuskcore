...
func DefaultDataDir() string {
	...
	case "darwin":
		...
		oldPath := filepath.Join(home, "Library", "Kusk")
		newPath := filepath.Join(home, "Library", "Application Support", "Kusk")
		...
		return newPath
	case "windows":
		return filepath.Join(home, "AppData", "Roaming", "Kusk")
	default:
		return filepath.Join(home, ".kusk")
	}
}
