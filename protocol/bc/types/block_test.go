				...
				Transactions: []*Tx{
					NewTx(TxData{
						...
						Inputs: []*TxInput{
							...
							NewSpendInput([][]byte{[]byte("arguments3"), []byte("arguments4")}, testutil.MustDecodeHash("fad5195a0c8e3b590b86a3c0a95e7529565888508aecca96e9aeda633002f409"), *consensus.KUSKAssetID, 254354, 3, []byte("spendProgram"), [][]byte{[]byte("stateData")}),
						},
						Outputs: []*TxOutput{
					...
					NewTx(TxData{
						...
						Outputs: []*TxOutput{
							NewOriginalTxOutput(*consensus.KUSKAssetID, 254354, []byte("true"), [][]byte{[]byte("stateData")}),
							NewOriginalTxOutput(*consensus.KUSKAssetID, 254354, []byte("false"), [][]byte{[]byte("stateData")}),
						},
					}),
				},
			},
