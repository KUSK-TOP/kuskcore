...
var testTxs = []*types.Tx{
	...
	types.NewTx(types.TxData{
		...
		Inputs: []*types.TxInput{
			types.NewSpendInput(nil, bc.NewHash([32]byte{0x01}), *consensus.KUSKAssetID, 1, 1, []byte{0x51}, nil),
		},
	...
	types.NewTx(types.TxData{
		...
		Outputs: []*types.TxOutput{
			types.NewOriginalTxOutput(*consensus.KUSKAssetID, 1, []byte{0x6b}, nil),
		},
	}),
	//tx2
	types.NewTx(types.TxData{
	...
	types.NewTx(types.TxData{
		...
		Outputs: []*types.TxOutput{
			types.NewOriginalTxOutput(*consensus.KUSKAssetID, 0, []byte{0x51}, nil),
		},
	}),
	//tx6
	types.NewTx(types.TxData{
		SerializedSize: 100,
		Inputs: []*types.TxInput{
			types.NewSpendInput(nil, bc.NewHash([32]byte{0x01}), *consensus.KUSKAssetID, 3, 1, []byte{0x51}, nil),
			types.NewSpendInput(nil, testutil.MustDecodeHash("d84d0be0fd08e7341f2d127749bb0d0844d4560f53bd54861cee9981fd922cad"), bc.NewAssetID([32]byte{0xa1}), 3, 0, []byte{0x62}, nil),
		},
		Outputs: []*types.TxOutput{
			types.NewOriginalTxOutput(*consensus.KUSKAssetID, 2, []byte{0x51}, nil),
