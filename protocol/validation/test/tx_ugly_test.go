	...
	cases := []struct {
			...
			txData: types.TxData{
				...
				Inputs: []*types.TxInput{
					types.NewSpendInput(nil,
						...
						*consensus.KUSKAssetID, 10000000000, 0, nil, nil),
				},
				Outputs: []*types.TxOutput{
					types.NewOriginalTxOutput(*consensus.KUSKAssetID, 10000000001, testutil.MustDecodeHexString("00145931e1b7b65897f47845ac08fc136e0c0a4ff166"), nil),
				},
			},
			err: true,
		},
		{
			...
			txData: types.TxData{
				...
				Outputs: []*types.TxOutput{
					types.NewOriginalTxOutput(*consensus.KUSKAssetID, 10000000000, testutil.MustDecodeHexString("00145931e1b7b65897f47845ac08fc136e0c0a4ff166"), nil),
				},
			},
			err: true,
		},
		{
			...
			txData: types.TxData{
				...
				Inputs: []*types.TxInput{
					types.NewSpendInput(nil,
						bc.Hash{V0: 14760873410800997144, V1: 1698395500822741684, V2: 5965908492734661392, V3: 9445539829830863994},
						*consensus.KUSKAssetID, 10000000001, 0, nil, nil),
				},
				Outputs: []*types.TxOutput{
					types.NewOriginalTxOutput(*consensus.KUSKAssetID, 10000000000, testutil.MustDecodeHexString("00145931e1b7b65897f47845ac08fc136e0c0a4ff166"), nil),
				},
		...
		},
		{
			...
			txData: types.TxData{
				...
				Outputs: []*types.TxOutput{
					types.NewOriginalTxOutput(*consensus.KUSKAssetID, 9000000000, testutil.MustDecodeHexString("00145931e1b7b65897f47845ac08fc136e0c0a4ff166"), nil),
				},
			},
			err: true,
		},
		...
		},
		{
			...
			txData: types.TxData{
				...
				Inputs: []*types.TxInput{
					types.NewSpendInput(nil,
						bc.Hash{V0: 14760873410800997144, V1: 1698395500822741684, V2: 5965908492734661392, V3: 9445539829830863994},
						*consensus.KUSKAssetID, 10000000000, 0, testutil.MustDecodeHexString("6a"), nil),
				},
				Outputs: []*types.TxOutput{
					types.NewOriginalTxOutput(*consensus.KUSKAssetID, 9000000000, testutil.MustDecodeHexString("00145931e1b7b65897f47845ac08fc136e0c0a4ff166"), nil),
				},
		...
		},
		{
			...
			txData: types.TxData{
				...
				Inputs: []*types.TxInput{
					types.NewSpendInput(nil,
						bc.Hash{V0: 14760873410800997144, V1: 1698395500822741684, V2: 5965908492734661392, V3: 9445539829830863994},
						*consensus.KUSKAssetID, 0, 0, nil, nil),
				},
				Outputs: []*types.TxOutput{
					types.NewOriginalTxOutput(*consensus.KUSKAssetID, 0, testutil.MustDecodeHexString("00145931e1b7b65897f47845ac08fc136e0c0a4ff166"), nil),
				},
			},
			err: true,
		},
		{
			...
			txData: types.TxData{
				...
				Inputs:  []*types.TxInput{},
				Outputs: []*types.TxOutput{
					types.NewOriginalTxOutput(*consensus.KUSKAssetID, 10, testutil.MustDecodeHexString("00145931e1b7b65897f47845ac08fc136e0c0a4ff166"), nil),
				},
			},
			err: true,
		},
		{
			...
			txData: types.TxData{
				...
				Inputs: []*types.TxInput{
					types.NewSpendInput(nil,
						bc.Hash{V0: 14760873410800997144, V1: 1698395500822741684, V2: 5965908492734661392, V3: 9445539829830863994},
						*consensus.KUSKAssetID, math.MaxUint64, 0, nil, nil),
					types.NewSpendInput(nil,
						bc.Hash{V0: 6970879411704044573, V1: 10086395903308657573, V2: 10107608596190358115, V3: 8645856247221333302},
						*consensus.KUSKAssetID, 10000000000, 1, nil, nil),
				},
				Outputs: []*types.TxOutput{
					types.NewOriginalTxOutput(*consensus.KUSKAssetID, 10000000000, testutil.MustDecodeHexString("00145931e1b7b65897f47845ac08fc136e0c0a4ff166"), nil),
				},
		...
		},
		{
			...
			txData: types.TxData{
				...
				Outputs: []*types.TxOutput{
					types.NewOriginalTxOutput(*consensus.KUSKAssetID, math.MaxUint64, testutil.MustDecodeHexString("00145931e1b7b65897f47845ac08fc136e0c0a4ff166"), nil),
				},
			},
			err: true,
		},
		{
			...
			txData: types.TxData{
				...
				Outputs: []*types.TxOutput{
					types.NewOriginalTxOutput(*consensus.KUSKAssetID, math.MaxUint64, testutil.MustDecodeHexString("6a"), nil),
				},
			},
			err: true,
		},
		...
		},
		{
			...
			txData: types.TxData{
				...
				Inputs: []*types.TxInput{
					types.NewSpendInput(nil,
						bc.Hash{V0: 14760873410800997144, V1: 1698395500822741684, V2: 5965908492734661392, V3: 9445539829830863994},
						*consensus.KUSKAssetID, 100000000, 0, nil, nil),
				},
				Outputs: []*types.TxOutput{
					types.NewOriginalTxOutput(*consensus.KUSKAssetID, 18446744073609551616, testutil.MustDecodeHexString("00145931e1b7b65897f47845ac08fc136e0c0a4ff166"), nil),
					types.NewOriginalTxOutput(*consensus.KUSKAssetID, 18446744073609551616, testutil.MustDecodeHexString("00145931e1b7b65897f47845ac08fc136e0c0a4ff166"), nil),
					types.NewOriginalTxOutput(*consensus.KUSKAssetID, 290000000, testutil.MustDecodeHexString("00145931e1b7b65897f47845ac08fc136e0c0a4ff166"), nil),
				},
			},
			err: true,
		},
		{
			...
			txData: types.TxData{
				...
				Inputs: []*types.TxInput{
					types.NewSpendInput(nil,
						bc.Hash{V0: 14760873410800997144, V1: 1698395500822741684, V2: 5965908492734661392, V3: 9445539829830863994},
						*consensus.KUSKAssetID, 10000000000, 0, testutil.MustDecodeHexString("00140876db6ca8f4542a836f0edd42b87d095d081182"), nil), // wrong control program
				},
				Outputs: []*types.TxOutput{
					types.NewOriginalTxOutput(*consensus.KUSKAssetID, 9000000000, testutil.MustDecodeHexString("00145931e1b7b65897f47845ac08fc136e0c0a4ff166"), nil),
				},
		...
		},
		{
			...
			txData: types.TxData{
				...
				Inputs: []*types.TxInput{
					types.NewSpendInput(nil,
						bc.Hash{V0: 14760873410800997144, V1: 1698395500822741684, V2: 5965908492734661392, V3: 9445539829830863994},
						*consensus.KUSKAssetID, 10000000000, 0, testutil.MustDecodeHexString("00200824e931fb806bd77fdcd291aad3bd0a4493443a4120062bd659e64a3e0bac66"), nil), // wrong control program
				},
				Outputs: []*types.TxOutput{
					types.NewOriginalTxOutput(*consensus.KUSKAssetID, 9000000000, testutil.MustDecodeHexString("00145931e1b7b65897f47845ac08fc136e0c0a4ff166"), nil),
				},
		...
		},
		{
			...
			txData: types.TxData{
				...
				Inputs: []*types.TxInput{
					types.NewSpendInput(nil,
						bc.Hash{V0: 14760873410800997144, V1: 1698395500822741684, V2: 5965908492734661392, V3: 9445539829830863994},
						*consensus.KUSKAssetID, 10000000000, 0, testutil.MustDecodeHexString("001420a1af4fc11399e6cd7253abf1bbd4d0af17daad"), nil),
					types.NewSpendInput(nil,
						bc.Hash{V0: 14760873410800997144, V1: 1698395500822741684, V2: 5965908492734661392, V3: 9445539829830863994},
						*consensus.KUSKAssetID, 10000000000, 0, testutil.MustDecodeHexString("001420a1af4fc11399e6cd7253abf1bbd4d0af17daad"), nil),
				},
				Outputs: []*types.TxOutput{
					types.NewOriginalTxOutput(*consensus.KUSKAssetID, 19000000000, testutil.MustDecodeHexString("00145931e1b7b65897f47845ac08fc136e0c0a4ff166"), nil),
				},
			},
			err: true,
		},
