				...
				Transactions: []*types.Tx{
					types.NewTx(types.TxData{
						...
						Outputs: []*types.TxOutput{
							types.NewOriginalTxOutput(*consensus.KUSKAssetID, 0, []byte("controlProgram"), nil),
						},
					}),
				},
			},
			...
			block: &types.Block{
				...
				Transactions: []*types.Tx{
					types.NewTx(types.TxData{
						Inputs: []*types.TxInput{types.NewCoinbaseInput(nil)},
						Outputs: []*types.TxOutput{
							types.NewOriginalTxOutput(*consensus.KUSKAssetID, 5000, []byte("controlProgram"), nil),
						},
					}),
				},
			},
			...
			block: &types.Block{
				...
				Transactions: []*types.Tx{
					types.NewTx(types.TxData{
						Inputs: []*types.TxInput{types.NewCoinbaseInput(nil)},
						Outputs: []*types.TxOutput{
							types.NewOriginalTxOutput(*consensus.KUSKAssetID, 0, []byte("controlProgramX1"), nil),
							types.NewOriginalTxOutput(*consensus.KUSKAssetID, 5000, []byte("controlProgram"), nil),
						},
					}),
				},
			...
			block: &types.Block{
				...
				Transactions: []*types.Tx{
					types.NewTx(types.TxData{
						Inputs: []*types.TxInput{types.NewCoinbaseInput(nil)},
						Outputs: []*types.TxOutput{
							types.NewOriginalTxOutput(*consensus.KUSKAssetID, 1000, []byte("controlProgram"), nil),
							types.NewOriginalTxOutput(*consensus.KUSKAssetID, 5000, []byte("controlProgram"), nil),
						},
					}),
				},
			...
			block: &types.Block{
				...
				Transactions: []*types.Tx{
					types.NewTx(types.TxData{
						Inputs: []*types.TxInput{types.NewCoinbaseInput(nil)},
						Outputs: []*types.TxOutput{
							types.NewOriginalTxOutput(*consensus.KUSKAssetID, 5000, []byte("controlProgram1"), nil),
							types.NewOriginalTxOutput(*consensus.KUSKAssetID, 5000, []byte("controlProgram2"), nil),
						},
					}),
				},
			},
