	...
	cases := []struct {
			...
			txData: &types.TxData{
				...
				Inputs: []*types.TxInput{
					types.NewSpendInput(
						...
						bc.Hash{V0: 2},
						*consensus.KUSKAssetID, 1000000000, 0, testutil.MustDecodeHexString("0014f233267911e94dc74df706fe3b697273e212d545"), [][]byte{}),
				},
				Outputs: []*types.TxOutput{
					types.NewOriginalTxOutput(*consensus.KUSKAssetID, 100, testutil.MustDecodeHexString("0014f233267911e94dc74df706fe3b697273e212d545"), [][]byte{}),
				},
			},
			err: nil,
		},
			...
			txData: &types.TxData{
				...
				Inputs: []*types.TxInput{
					types.NewSpendInput(
						...
						*consensus.KUSKAssetID, 11818900000, 0, testutil.MustDecodeHexString("0014f233267911e94dc74df706fe3b697273e212d545"), nil),
					types.NewSpendInput(
						[][]byte{
						...
						*consensus.KUSKAssetID, 99439999900, 2, testutil.MustDecodeHexString("0014f233267911e94dc74df706fe3b697273e212d545"), nil),
				},
				Outputs: []*types.TxOutput{
					types.NewOriginalTxOutput(*consensus.KUSKAssetID, 1818900000, testutil.MustDecodeHexString("00145931e1b7b65897f47845ac08fc136e0c0a4ff166"), nil),
					types.NewOriginalTxOutput(*consensus.KUSKAssetID, 89439999900, testutil.MustDecodeHexString("0014ca1f877c2787f746a4473adac932171dd18d55d7"), nil),
					types.NewOriginalTxOutput(*consensus.KUSKAssetID, 19900000000, testutil.MustDecodeHexString("00145ade29df622cc68d0473aa1a20fb89690451c66e"), nil),
				},
			},
			err: nil,
		},
			...
			txData: &types.TxData{
				...
				Inputs: []*types.TxInput{
					types.NewSpendInput(
						...
						bc.Hash{V0: 14760873410800997144, V1: 1698395500822741684, V2: 5965908492734661392, V3: 9445539829830863994},
						*consensus.KUSKAssetID, 11818900000, 0, testutil.MustDecodeHexString("0014e6e1f8b11f1cfb7609037003b90f64837afd272c"), nil),
					types.NewSpendInput(
						[][]byte{
						...
						*consensus.KUSKAssetID, 99960000000, 1, testutil.MustDecodeHexString("0014cfbccfac5018ad4b4bfbcb1fab834e3c85037460"), nil),
				},
				Outputs: []*types.TxOutput{
					types.NewOriginalTxOutput(*consensus.KUSKAssetID, 1818900000, testutil.MustDecodeHexString("00144b5637cc25b188136f440484f210541fa2a7ce64"), nil),
					types.NewOriginalTxOutput(*consensus.KUSKAssetID, 89960000000, testutil.MustDecodeHexString("0014c7271a69dba57331b36221118dfeb1b1793933df"), nil),
					types.NewOriginalTxOutput(*consensus.KUSKAssetID, 20000000000, testutil.MustDecodeHexString("0014447e597c1c326ad1a639f8023d3f87ae22a4e049"), nil),
				},
			},
		...
		},
		{
			...
			txData: &types.TxData{
				...
				Outputs: []*types.TxOutput{
					types.NewOriginalTxOutput(*consensus.KUSKAssetID, 11718900000, testutil.MustDecodeHexString("0014f233267911e94dc74df706fe3b697273e212d545"), nil),
					types.NewOriginalTxOutput(*consensus.KUSKAssetID, 90000000, []byte{byte(vm.OP_FAIL)}, nil),
				},
			},
			err: nil,
		},
			...
			txData: &types.TxData{
				...
				Inputs: []*types.TxInput{
					types.NewSpendInput(
						...
						bc.Hash{V0: 14760873410800997144, V1: 1698395500822741684, V2: 5965908492734661392, V3: 9445539829830863994},
						*consensus.KUSKAssetID, 11818900000, 0, testutil.MustDecodeHexString("0014f233267911e94dc74df706fe3b697273e212d545"), [][]byte{}),
				...
				Outputs: []*types.TxOutput{
					types.NewOriginalTxOutput(*consensus.KUSKAssetID, 1818900000, testutil.MustDecodeHexString("00147d6b00edfbbc758a5da6130a5fa1a4cfec8422c3"), nil),
					types.NewOriginalTxOutput(*consensus.KUSKAssetID, 9900000000, []byte{byte(vm.OP_FAIL)}, nil),
		...
		},
		{
			...
			txData: &types.TxData{
				...
				Outputs: []*types.TxOutput{
					types.NewOriginalTxOutput(*consensus.KUSKAssetID, 1818900000, testutil.MustDecodeHexString("001482b7991d64d001009b673ffe3ca2b35eab14f142"), nil),
					types.NewOriginalTxOutput(*consensus.KUSKAssetID, 10000000000, []byte{byte(vm.OP_FAIL)}, nil),
			...
			txData: &types.TxData{
				...
				Inputs: []*types.TxInput{
					types.NewSpendInput(
						...
						*consensus.KUSKAssetID, 21819700000, 0, testutil.MustDecodeHexString("001411ef7695d46e1f9288d996c3daa6ff4d956ac355"), nil),
				},
				Outputs: []*types.TxOutput{
					types.NewOriginalTxOutput(*consensus.KUSKAssetID, 11818900000, testutil.MustDecodeHexString("001415c956112c2b46354690e36051803cc9d5a8f26b"), nil),
					types.NewOriginalTxOutput(*consensus.KUSKAssetID, 10000000000, testutil.MustDecodeHexString("00149c9dd93184cc34ac5d47c145c5af3df852235aad"), nil),
				},
			},
			...
			txData: &types.TxData{
				...
				Inputs: []*types.TxInput{
					...
					types.NewSpendInput(
						...
						*consensus.KUSKAssetID, 9800000000, 2, testutil.MustDecodeHexString("0014f233267911e94dc74df706fe3b697273e212d545"),
						nil),
				},
				Outputs: []*types.TxOutput{
					types.NewOriginalTxOutput(
						...
						nil),
					types.NewOriginalTxOutput(*consensus.KUSKAssetID, 9750000000, testutil.MustDecodeHexString("0014ec75fda5c727cb0d41137ab62afbf9070a405744"), nil),
				},
			},
			err: nil,
		},
