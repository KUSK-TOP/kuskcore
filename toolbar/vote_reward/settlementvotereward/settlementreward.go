...
import (
	...
	"kuskcore/consensus"
	"kuskcore/errors"
	"kuskcore/toolbar/apinode"
	"kuskcore/toolbar/common"
	"kuskcore/toolbar/vote_reward/config"
)
...
func (s *SettlementReward) Settlement() error {
	...
	// send transactions
	return s.node.BatchSendKUSK(s.rewardCfg.AccountID, s.rewardCfg.Password, s.rewards, data)
}
