	...
	cases := []struct {
	...
	}{
		{
			tx: types.NewTx(types.TxData{
				...
				Outputs: []*types.TxOutput{
					types.NewOriginalTxOutput(*consensus.KUSKAssetID, 41250000000, []byte{0x51}, nil),
				},
			}),
			statusFail: false,
			wantUtxos:  []*account.UTXO{},
		},
		{
			tx: types.NewTx(types.TxData{
				...
				Outputs: []*types.TxOutput{
					types.NewOriginalTxOutput(*consensus.KUSKAssetID, 4125, []byte{0x51}, nil),
				},
			}),
			statusFail: false,
			wantUtxos:  []*account.UTXO{},
		},
		{
			tx: types.NewTx(types.TxData{
				Inputs: []*types.TxInput{
					...
					types.NewSpendInput([][]byte{}, bc.Hash{V0: 3}, *consensus.KUSKAssetID, 5, 3, []byte{0x53}, nil),
					types.NewSpendInput([][]byte{}, bc.Hash{V0: 4}, *consensus.KUSKAssetID, 7, 4, []byte{0x54}, nil),
				},
				Outputs: []*types.TxOutput{
					types.NewOriginalTxOutput(bc.AssetID{V0: 1}, 4, []byte{0x51}, nil),
					types.NewOriginalTxOutput(*consensus.KUSKAssetID, 12, []byte{0x53}, nil),
				},
			}),
			statusFail: false,
			wantUtxos: []*account.UTXO{
		...
		},
		{
			tx: types.NewTx(types.TxData{
				Inputs: []*types.TxInput{
					...
					types.NewSpendInput([][]byte{}, bc.Hash{V0: 2}, *consensus.KUSKAssetID, 7, 1, []byte{0x51}, nil),
				},
				Outputs: []*types.TxOutput{
					types.NewOriginalTxOutput(bc.AssetID{V0: 1}, 2, []byte{0x51}, nil),
					types.NewOriginalTxOutput(bc.AssetID{V0: 1}, 3, []byte{0x52}, nil),
					types.NewOriginalTxOutput(*consensus.KUSKAssetID, 2, []byte{0x53}, nil),
					types.NewOriginalTxOutput(*consensus.KUSKAssetID, 5, []byte{0x54}, nil),
				},
			}),
			statusFail:  false,
			blockHeight: 0,
