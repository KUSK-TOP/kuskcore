					...
					Transactions: []*types.Tx{
						types.NewTx(types.TxData{
							...
							Outputs: []*types.TxOutput{
								types.NewOriginalTxOutput(*consensus.KUSKAssetID, 41250000000, testutil.MustDecodeHexString("0014024bb9bfc639bdac292ff9ceb41b5c6f5a970eab"), [][]byte{}),
							},
						}),
					},
				},
				...
				block: &types.Block{
					...
					Transactions: []*types.Tx{
						types.NewTx(types.TxData{
							...
							Outputs: []*types.TxOutput{
								types.NewOriginalTxOutput(*consensus.KUSKAssetID, 41250000000, testutil.MustDecodeHexString("00143d05e891b165b165afefa2e861e83a9745f80d8c"), [][]byte{}),
							},
						}),
					},
				},
				...
				block: &types.Block{
					...
					Transactions: []*types.Tx{
						types.NewTx(types.TxData{
							...
							Outputs: []*types.TxOutput{
								types.NewOriginalTxOutput(*consensus.KUSKAssetID, 41350000000, testutil.MustDecodeHexString("0014024bb9bfc639bdac292ff9ceb41b5c6f5a970eab"), [][]byte{}),
							},
						}),
						types.NewTx(types.TxData{
							Version:   1,
							...
							Inputs: []*types.TxInput{
								types.NewSpendInput(
									...
									*consensus.KUSKAssetID, 10000000000, 0,
									testutil.MustDecodeHexString("0014cade6dd7cbe2ea2b8ab90dfb8756dda4ba1624bc"),
									[][]byte{},
								),
							},
							Outputs: []*types.TxOutput{
								types.NewOriginalTxOutput(*consensus.KUSKAssetID, 9900000000, testutil.MustDecodeHexString("00143d05e891b165b165afefa2e861e83a9745f80d8c"), [][]byte{}),
							},
						}),
					},
				},
				...
				block: &types.Block{
					...
					Transactions: []*types.Tx{
						...
						types.NewTx(types.TxData{
							...
							Outputs: []*types.TxOutput{
								types.NewOriginalTxOutput(*consensus.KUSKAssetID, 9900000000, testutil.MustDecodeHexString("6a"), [][]byte{}), // retire
							},
						}),
					},
				},
				...
				block: &types.Block{
					...
					Transactions: []*types.Tx{
						...
						types.NewTx(types.TxData{
							...
							Outputs: []*types.TxOutput{
								types.NewOriginalTxOutput(*consensus.KUSKAssetID, 9900000000, testutil.MustDecodeHexString("0014024bb9bfc639bdac292ff9ceb41b5c6f5a970eab"), [][]byte{}),
