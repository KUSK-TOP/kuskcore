...
//}
//
//func BenchmarkChain_KuskTx_NoAsset_BASE(b *testing.B) {
//	benchInsertChain(b, 1, 0, "")
//}
//
//func BenchmarkChain_5000KuskTx_NoAsset_BASE(b *testing.B) {
//	benchInsertChain(b, 5000, 0, "")
//}
//
//func BenchmarkChain_5000KuskTx_1Asset_BASE(b *testing.B) {
//	benchInsertChain(b, 5000, 1, "")
//}
//
//// standard Transaction
//func BenchmarkChain_KuskTx_NoAsset_P2PKH(b *testing.B) {
//	benchInsertChain(b, 1000, 0, "P2PKH")
//}
//
//func BenchmarkChain_KuskTx_1Asset_P2PKH(b *testing.B) {
//	benchInsertChain(b, 1000, 1, "P2PKH")
//}
//
//func BenchmarkChain_KuskTx_NoAsset_P2SH(b *testing.B) {
//	benchInsertChain(b, 100, 0, "P2SH")
//}
//
//func BenchmarkChain_KuskTx_1Asset_P2SH(b *testing.B) {
//	benchInsertChain(b, 100, 1, "P2SH")
//}
//
//func BenchmarkChain_KuskTx_NoAsset_MultiSign(b *testing.B) {
//	benchInsertChain(b, 100, 0, "MultiSign")
//}
//
//func BenchmarkChain_KuskTx_1Asset_MultiSign(b *testing.B) {
...
//	utxos := []*account.UTXO{}
//	for i := 0; i < num; i++ {
//		utxo := MockSimpleUtxo(uint64(i), consensus.KUSKAssetID, amount, ctrlProg)
...
//		}
//
//		utxo := MockSimpleUtxo(0, consensus.KUSKAssetID, 1000000000, controlProg)
