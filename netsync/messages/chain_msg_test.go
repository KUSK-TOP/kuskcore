...
var txs = []*types.Tx{
	types.NewTx(types.TxData{
		...
		Outputs:        []*types.TxOutput{types.NewOriginalTxOutput(*consensus.KUSKAssetID, 5000, nil, nil)},
	}),
	types.NewTx(types.TxData{
	...
	types.NewTx(types.TxData{
		SerializedSize: uint64(54),
		Inputs:         []*types.TxInput{types.NewCoinbaseInput([]byte{0x01, 0x02, 0x03})},
		Outputs:        []*types.TxOutput{types.NewOriginalTxOutput(*consensus.KUSKAssetID, 2000, nil, nil)},
	}),
	types.NewTx(types.TxData{
		SerializedSize: uint64(54),
		Inputs:         []*types.TxInput{types.NewCoinbaseInput([]byte{0x01, 0x02, 0x03})},
		Outputs:        []*types.TxOutput{types.NewOriginalTxOutput(*consensus.KUSKAssetID, 10000, nil, nil)},
	}),
}
