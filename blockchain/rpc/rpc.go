...
import (
	...
	"kuskcore/net/http/reqid"
)

// Kusk-specific header fields
const (
	HeaderBlockchainID = "Blockchain-ID"
	HeaderCoreID       = "Kusk-Core-ID"
...
// A Client is a Kusk RPC client. It performs RPCs over HTTP using JSON
...
func (c Client) userAgent() string {
	return fmt.Sprintf("Kusk; process=%s; buildtag=%s; blockchainID=%s",
