...
import (
	...
	"kuskcore/env"
	"kuskcore/event"
	kuskLog "kuskcore/log"
	"kuskcore/net/websocket"
	"kuskcore/netsync"
	"kuskcore/protocol"
	w "kuskcore/wallet"
)
...
func NewNode(config *cfg.Config) *Node {
	...
	if profileHost != "" {
		// Profiling kuskd programs.see (https://blog.golang.org/profiling-go-programs)
...
func initNodeConfig(config *cfg.Config) error {
	...
	if err := kuskLog.InitLogFile(config); err != nil {
